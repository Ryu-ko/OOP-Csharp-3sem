...
namespace lab12
{
    internal class STSFileManager
    {
        ...
        public static void CreateDir( string path )
        {
            ...
            STSLog.WriteInLog(CreateDirLog);
        ...
        public static void CopyFiles( string path, string path2, string path3 )
        {
            ...
            STSLog.WriteInLog(CopyFilesLog);
        }
